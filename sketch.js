...
function preload(){
  ...
  trex_running = loadAnimation ("soldier.png");
  //loading the trex's image when collided
  trex_collided = loadAnimation ("blast.png")
  //loading the cloud image
  cloudImage = loadImage ("missile.png");
  //loading the obsacle images
  obstacle1 = loadImage ("landmine.png");
  obstacle2 = loadImage ("csgo_c4 (3).png");
  obstacle3 = loadImage ("csgo_c4 (1).png");
  obstacle4 = loadImage ("mines_PNG15.png");
  obstacle5 = loadImage ("csgo_c4 (3).png");
  obstacle6 = loadImage ("csgo_c4 (1).png");
  ...
  backgroundImage = loadImage ("battle field.webp")
}
...
function setup(){
  ...
  ground = createSprite(300, 100, 800, 10);
